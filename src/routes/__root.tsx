...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Luxury atelier for atamfa, lace, intimates, bags, shoes, veils and signature perfumes. Order on WhatsApp." },
      { name: "author", content: "The Fashion Cove" },
